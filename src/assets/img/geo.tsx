  ...
  return (
    <svg className="flex-shrink-0 w-5 h-5 text-white transition duration-75 group-hover:text-gray-900 " xmlns="http://www.w3.org/2000/svg" fill="currentColor" width="512" height="512" x="0" y="0" viewBox="0 0 512 512">
      <g>
        ...
        <path d="m373.264 344.695-75.531 118.087c-19.551 30.482-64.024 30.382-83.481.029l-75.654-118.085C72.034 360.116 31 388.309 31 422c0 58.462 115.928 90 225 90s225-31.538 225-90c0-33.715-41.091-61.923-107.736-77.305z" opacity="1" data-original="#000000">
        </path>
      </g>
    </svg>
  )
